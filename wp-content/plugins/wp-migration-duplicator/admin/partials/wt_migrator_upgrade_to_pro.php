...
<div class="wt_wt_mgdp_to_pro" style="<?php echo $pro_width; ?> ">
    <table>
        <tr>
            <td style="width: 10%;padding-left: 15px;">
                <img src="<?php echo plugins_url(basename(plugin_dir_path(WT_MGDP_PLUGIN_FILENAME))) . '/admin/images/pro.svg' ?>" style="width: 100px;">
            </td> 
            ...
            <td style="width: 20%">
                <ul>
                    <li>
                        <span class="wt_sc_icon_box">
                            <img src="<?php echo plugins_url(basename(plugin_dir_path(WT_MGDP_PLUGIN_FILENAME))) . '/admin/images/banner1.svg' ?>" style="width: 18px;margin-top: 10px">
                        </span>
                        <b><?php _e('30 Day Money Back Guarantee', 'wp-migration-duplicator'); ?>
                    </li>
                    <li>
                        <span class="wt_sc_icon_box">
                            <img src="<?php echo plugins_url(basename(plugin_dir_path(WT_MGDP_PLUGIN_FILENAME))) . '/admin/images/banner.svg' ?>" style="width: 18px;margin-top: 5px">
                        </span>
                    ...
                    <li>
                        <a href="https://www.webtoffee.com/product/wordpress-backup-and-migration/?utm_source=free_plugin_sidebar&utm_medium=Migration_free&utm_campaign=WordPress_Backup&utm_content=<?php echo esc_attr(WP_MIGRATION_DUPLICATOR_VERSION);?>" class="wt-wt_mgdp-upgrade-to-pro-btn" target="_blank">
                            <img src="<?php echo plugins_url(basename(plugin_dir_path(WT_MGDP_PLUGIN_FILENAME))) . '/admin/images/pro_icon.svg' ?>"><?php _e('UPGRADE TO PREMIUM', 'wp-migration-duplicator'); ?>
                        </a>  </li>
                </ul>
            </td>
        </tr>
